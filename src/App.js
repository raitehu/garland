    ...
    <div className="App">
      ...
      <div className='footer'>
        ...
        <p>
          ...
          <br />
          本サービスの開発・運営はVALIS公式様とは無関係の、有志のファンによって行っていますので、本サービスへの質問やお問合せはVALIS公式様ではなく<a href='https://twitter.com/WANDERERSINFO'>WANDERER'S INFO運営</a>のDMまでお願いいたします。
        </p>

        <h3>ご利用のみなさまへ</h3>
        <p>
          本サービスでVALIS_ARTとは無関係なツイートの告知や、不適切表現を含む画像や文面のツイートが告知された場合はお手数ですが<a href='https://twitter.com/WANDERERSINFO'>WANDERER'S INFO運営</a>のDMまでご連絡ください。
          <br />
        ...
        <p>
          ...
          <br />
          誤って登録されて内容を変更したい場合や、期限内の削除を行いたい場合は<a href='https://twitter.com/WANDERERSINFO'>WANDERER'S INFO運営</a>のDMまでご連絡ください。
          <br />
        ...
        <dl>
          <dt>Twitter</dt>
          <dd><a href='https://twitter.com/VALIS_Official'>@VALIS_Official</a></dd>
          <dt>YouTube</dt>
          <dd><a href='https://www.youtube.com/c/VALIS_Official'>VALIS</a></dd>
          <dt>所属スタジオ</dt>
          <dd><a href='https://sinsekaistudio.jp/'>SINSEKAI STUDIO</a></dd>
        </dl>

        <h3>開発責任者</h3>
        <a href='https://twitter.com/RaitehuV'>霧島らいてふ</a>
